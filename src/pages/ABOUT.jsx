...
const About = () => {
    ...
    <Layout>
        ...
        <ImgTextWidget title={'What We Do'} ImgBanner={WhatWeDoImg} point1={'Phenom implementations and enterprise rollouts'} point2={'AI-driven HR automation'} point3={'HR systems integrations'} point4={'Quality assurance and platform stability'} point5={'Post-go-live support and managed services'}/>
        ...
        <ImgTextWidget title={'Why Enterprises Choose Techlinx'} ImgBanner={WhyChooseImg} point1={'Specialized focus on Phenom HR technology'} point2={'Proven experience across complex enterprise environments'} point3={'Reliable delivery with minimal post-go-live risk'} point4={'Trusted partner beyond implementation'}/>
        ...
        <ImgTextWidget title={'Our Commitment'} ImgBanner={Commitment} text={'We are committed to helping HR and talent teams build intelligent, scalable, and future-ready hiring platforms—delivered with precision and accountability.'}/>
    </Layout>
    </>
}
