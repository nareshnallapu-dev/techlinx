...
import { useNavigate } from 'react-router';
    ...
    function ImgTextWidgetTwoPlain({title, subTitle, text, ImgBanner, listItem, point1, point2, point3, point4, point5, cardBottomHead, cardBottomText, btnTxt}) {
    ...
    export default ImgTextWidgetTwoPlain;